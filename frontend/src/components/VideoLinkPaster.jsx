...
export default function VideoLinkPaster({
  onClose,
  onVideoLoaded,
  darkMode = false,
  workspaceId,
  ...
  const handleLoadVideo = async () => {
    ...
    if (!workspaceId) {
      setError("Select a workspace before adding a video");
      return;
    }
        ...
        <div className='flex-1 overflow-y-auto p-8'>
          ...
          {!videoLoaded && !loading ? (
            <div className='space-y-6'>
              {/* Paste Link Section */}
              <div
                className={`p-6 rounded-2xl border ${darkMode ? "bg-gray-750 border-gray-700" : "bg-purple-50 border-purple-200"}`}>
                <h3
              ...
              <div className='relative'>
                <div className={`absolute inset-0 flex items-center`}>
                  <div
                    className={`w-full border-t ${darkMode ? "border-gray-700" : "border-gray-200"}`}></div>
                </div>
                <div className='relative flex justify-center text-sm'>
                  <span
                    className={`px-4 ${darkMode ? "bg-gray-800 text-gray-400" : "bg-white text-gray-500"}`}>
                    OR
                  </span>
                </div>
              </div>
              ...
              <div
                className={`p-6 rounded-2xl border text-center ${darkMode ? "bg-gray-750 border-gray-700" : "bg-purple-50 border-purple-200"}`}>
                <Upload
                  className={`w-12 h-12 mx-auto mb-4 ${darkMode ? "text-purple-400" : "text-purple-600"}`}
                />
                <h3
            ...
            <div>
              {/* Video Preview */}
              <div
                className={`mb-8 rounded-2xl overflow-hidden ${darkMode ? "bg-gray-750" : "bg-gray-100"}`}>
                {uploadedVideo ? (
                  <div className='aspect-video flex items-center justify-center'>
                    <div className='text-center'>
                      <Play
                        className={`w-16 h-16 mx-auto mb-4 ${darkMode ? "text-purple-400" : "text-purple-600"}`}
                      />
                      <p
                        className={
                  ...
                  <button
                    ...
                    <div className='flex items-center gap-4'>
                      ...
                      <div>
                        ...
                        <p
                          className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-600"}`}>
                          Clear doubts and get explanations about the video
                          content
                        </p>
                      </div>
                    </div>

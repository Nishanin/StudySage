...
export default function Auth({ onLogin, onBack, darkMode = false }) {
  const [isRegister, setIsSignup] = useState(false);
  ...
  return (
    <div
      className={`min-h-screen ${darkMode ? "bg-gradient-to-br from-gray-900 via-gray-800 to-purple-900" : "bg-gradient-to-br from-purple-50 via-white to-violet-50"} flex items-center justify-center p-6`}>
      <button
        onClick={onBack}
      ...
      <div className='w-full max-w-md'>
        ...
        <div className='text-center mb-8'>
          ...
          <h1
            className={`text-3xl mb-2 ${darkMode ? "text-white" : "text-gray-900"}`}>
        ...
        {/* Auth Card */}
        <div
          className={`${darkMode ? "bg-gray-800/60 border-gray-700" : "bg-white border-purple-100"} rounded-3xl shadow-xl border p-8 backdrop-blur-sm`}>
          <div
            className={`flex gap-2 mb-8 ${darkMode ? "bg-gray-700/50" : "bg-purple-50"} rounded-xl p-1`}>
            <button
          ...
          <div
            ...
            <button
              onClick={() => setIsSignup(!isRegister)}
              className={
                darkMode
        ...
        <p
          className={`text-center text-sm mt-6 ${darkMode ? "text-gray-500" : "text-gray-500"}`}>
